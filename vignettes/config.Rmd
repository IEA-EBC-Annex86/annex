...
used in the article [Prepare data from textfiles](articles/from_textfiles.html);
...
* `column`: The name of the column in the imported data set (e.g., from an
  [XLSX file](articles/from_xlsx.html) or [text file](articles/from_textfiles.html)).
* `variable`: Defines the _new variable name_; one of the different variables (parameters)
  expected by the annex package (see [Variable definition](articles/lookupfunctions.html#variable-definition)).
* `study`: Name of the study the data belong to.
* `home`: Name of the home (building) the data belong to.
* `room`: Abbreviation of the type of room the data belong to (see [Room definition](articles/lookupfunctions.html#room-definition)).
* `unit`: Units of the input data (raw data); `annex_prepare()` will automatically
  convert to 'annex standard units (see [Variable definition](articles/lookupfunctions.html#variable-definition)).
...
See [Lookup functions](articles/lookupfunctions.html) to get a full list of the defined
values.
...
The two articles
[Prepare data from XLSX](articles/from_xlsx.html)
