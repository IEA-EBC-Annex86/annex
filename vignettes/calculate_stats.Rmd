...
continues the example used in the article [Prepare data from XLSX](articles/from_xlsx.html)
but works the very same way with the other examples included in the documentation, e.g.,
[Prepare data from textfiles](articles/from_textfiles.html).

Please have a look at [this](articles/from_xlsx.html) article for more information
