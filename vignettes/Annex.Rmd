...
print(raw)         # Content of the demo object
names(raw)         # Names of the variables
```

## Preparing data

The function [Annex::annex()] is used to prepare the data
...
The function [Annex::annex()] requires the date and time
...
The function [Annex::annex()] will (based on the formula) check
...
When calling [Annex::annex()] the grouping can now be specified as follows:
...
The S3 method [Annex::is.regular()] can be used to check whether or
