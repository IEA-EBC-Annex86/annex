...
* **annex_configuration**: Configuration (see article [Config file/objects](config.html))
...
For more details read the article about the [Config file/objects](config.html).
...
be detected, an error will be thrown (see [Config file/objects](config.html)).
